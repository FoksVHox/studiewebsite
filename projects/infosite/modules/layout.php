...
class Layout
{
    ...
    {
        ?>
            <div class="flex flex flex-row w-full w-screen">

                <div class="bg-gray-700 w-64 py-3 px-6 h-screen ">
                    <div class="mb-6">
                        <h1 class="text-white text-3xl font-medium text-center font-sans">SoMe</h1>
                    </div>
                    <div class="flex flex-col space-y-3">
                        <a class="block text-white font-medium py-2 px-2 bg-gray-600 rounded-lg flex justify-content items-center space-x-2" href="#">
