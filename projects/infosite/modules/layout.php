...
class Layout
{
    ...
    public function header()
    {
        ...
        <head>
            ...
            <link href="http://elev.htxroskilde.dk/2020/jimmih20/projects/infosite/css/style.css" rel="stylesheet">
            ...
            <div class="flex flex flex-row w-full w-screen h-screen">
                ...
                <div class="bg-gray-700 w-64 py-3 px-6 h-screen ">
                    ...
                    <div class="flex flex-col space-y-3">
                        <a class="block text-white font-medium py-2 px-2 bg-gray-600 rounded-lg flex justify-content items-center space-x-2" href="http://elev.htxroskilde.dk/2020/jimmih20/projects/infosite/index.php">
                        ...
                        <a class="block text-white font-medium py-2 px-2 bg-gray-600 rounded-lg flex justify-content items-center space-x-2" href="http://elev.htxroskilde.dk/2020/jimmih20/projects/infosite/articles.php">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
                            </svg>
                            <span>Artikler</span>
                        </a>
                        <a class="block text-white font-medium py-2 px-2 bg-gray-600 rounded-lg flex justify-content items-center space-x-2" href="http://elev.htxroskilde.dk/2020/jimmih20/projects/infosite/help.php">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
