<aside class="w-full md:w-64 bg-gray-800 md:min-h-screen" x-data="{ isOpen: false }">
    <div class="flex items-center justify-between bg-gray-900 p-4 h-16">
        <a href="#" class="flex items-center">
            ...
            <span class="text-gray-300 text-xl font-semibold mx-2">Jimmi's Site Docs</span>
        </a>
    ...
    <div class="px-2 py-4 md:block" :class="isOpen? 'block': 'hidden'" >
        <ul>
            <li class="px-2 py-3 bg-gray-800 rounded hover:bg-gray-900">
                <a href="#" class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                    <span class="mx-2 text-gray-300">Tilbage</span>
                </a>
            </li>
        </ul>
    </div>
